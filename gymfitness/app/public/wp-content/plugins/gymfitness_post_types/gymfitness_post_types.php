...
Version: 1.0.0
Author: Jonathan Stevan Bernal Orjuela
...
function gymfitness_clases_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Clases', 'Post Type General Name', 'gymfitness' ),// El nombre de nuestro post type
...
// Register Custom Post Type instructores
...
// Registrar custom post type de testimonios
