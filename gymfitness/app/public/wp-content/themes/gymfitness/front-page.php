...
<!--Custon field de areas de imagenes-->
<!--Imagenes del gym-->
<div class="seccion-areas"> 
    <ul class="contenedor-areas">
        <li class="area">
           ...
           ?>
           <img src="<?php echo esc_url($imagen); ?>" alt="<?php echo $area1['area_texto'];?>">
        ...
        <li class="area">
           ...
           ?>
           <img src="<?php echo esc_url($imagen); ?>" alt="<?php echo $area2['area_texto'];?>">
        ...
        <li class="area">
           ...
           ?>
           <img src="<?php echo esc_url($imagen); ?>" alt="<?php echo $area3['area_texto'];?>">
        ...
        <li class="area">
           ...
           ?>
           <img src="<?php echo esc_url($imagen); ?>" alt="<?php echo $area4['area_texto'];?>">
...
<section class="clases">
    <div class="contenedor seccion">
        ...
        <div class="contendor-boton">
            <a  class="boton boton-primario" href="<?php echo esc_url(get_permalink(get_page_by_title('Nuestras Clases'))); ?>">
                ...
                <li class="instructor">
                    ...
                    <div class="contenido text-center">
                        ...
                        <div class="especialidad">
                            <?php $especialidad = get_field('especialidad');
                                  
                                  foreach($especialidad as $esp): ?>
                                    <span class="etiqueta"><?php echo esc_html($esp); ?></span>
...
<p class="">Aprende tips de nuestros instructores expertos</p> 
